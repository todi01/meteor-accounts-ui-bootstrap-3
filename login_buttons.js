(function() {
    ...
    Accounts._loginButtons.validateUsername = function(username) {
        if (username.length >= 3) {
            ...
            loginButtonsSession.errorMessage(i18n('LOGIN.ERROR_USERNAME_AT_LEAST_3_CHARS'));
            return false;
        }
    };
    Accounts._loginButtons.validateEmail = function(email) {
        ...
        if (re.test(email)) {
            ...
            loginButtonsSession.errorMessage(i18n('LOGIN.ERROR_INVALID_EMAIL'));
            return false;
        }
    };
    Accounts._loginButtons.validatePassword = function(password) {
        if (password.length >= 6) {
            ...
            loginButtonsSession.errorMessage(i18n('LOGIN.ERROR_PASSWORD_AT_LEAST_6_CHARS'));
            return false;
        }
    };
